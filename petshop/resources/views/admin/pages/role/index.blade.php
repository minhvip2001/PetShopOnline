                        ...
                        <div class="ui-title-bar ">
                            ...
                            <div class="ui-title-bar__main-group">
                                <div class="ui-title-bar__heading-group">
                                    ...
                                    <h1 class="ui-title-bar__title">Vai trò</h1>
                                </div>
                                    ...
                                    <div class="ui-title-bar__mobile-primary-actions">
                                        <div class="ui-title-bar__actions">
                                            <a href="{{route('role.create')}}"
                                                class="ui-button ui-button--primary ui-title-bar__action">Tạo vai
                                                trò</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="ui-title-bar__actions-group">
                                <div class="ui-title-bar__actions">
                                    <a href="{{route('role.create')}}"
                                        class="ui-button ui-button--primary ui-title-bar__action">Tạo vai trò</a>
                                </div>
                            </div>
                        </div>
                                                            ...
                                                            <tr class="">
                                                                ...
                                                                <td>
                                                                    <a data-nested-link-target="true"
                                                                        href="{{route('role.edit', $role->id)}}">{{$role->name}}</a>
                                                                    <div>
                                                                    </div>
                                                                </td>
                                                                <td>
