...
<head>
	...
	<meta name="description" content="Cutepets - Siêu thị thú cưng Pet shop Hà Nội - Thanh toán đơn hàng" />
	<title>Cutepets - Siêu thị thú cưng Pet shop Hà Nội - Thanh toán đơn hàng</title>


	<link rel="shortcut icon"
		href="//bizweb.dktcdn.net/100/307/433/themes/751183/assets/checkout_favicon.ico?1621568561910"
		type="image/x-icon" />
	...
	<script src="{{asset('asset/frontend/js/checkout.min.js')}}"></script>
												...
												<div class="field__input-btn-wrapper">
													<div class="field__input-wrapper">
														...
														<input name="reductionCode" id="reductionCode" type="text" class="field__input"
															autocomplete="off" data-bind-disabled="isLoadingReductionCode"
